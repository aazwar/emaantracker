...
ملحوظة، كل معلوماتك ستظل سرية `}
            ...
            <ListItem style={listItem}>
              <Text style={styles.text}>{`فى هذا القسم سوف تدخل نشاطك اليومى الخاص بتلاوة وقراءة القرآن. هناك اختيارات إذا ماكنت تقرأ فقط أو تقرأ مع الترجمة أو التفسير.
...
اليوم هناك الكثير من التفاسير المتاحة سواء على صورة كتب أو على شبكة الانترنت، لذلك فضلا اقض بعض الوقت يوميا فى قراءة وفهم معانى كتاب الله.
 `}</Text>
            ...
            <ListItem style={listItem}>
              <Text style={styles.text}>{`فى هذا القسم ستتمكن من إدخال أنشطتك اليومية مثل نوافل العبادات كالصيام والإنفاق والصدقات وغيرها، فضلا اقض بعض الوقت يوميا لإدخالهم.`}</Text>
            </ListItem>
            <ListItem style={listItem}>
